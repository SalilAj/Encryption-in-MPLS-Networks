...
struct nbrec_acl *
nbrec_acl_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_acl *) ovsdb_idl_index_init_row(idl, class_);
}
...
struct nbrec_address_set *
nbrec_address_set_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_address_set *) ovsdb_idl_index_init_row(idl, class_);
}
...
struct nbrec_connection *
nbrec_connection_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_connection *) ovsdb_idl_index_init_row(idl, class_);
}
...
struct nbrec_dhcp_options *
nbrec_dhcp_options_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_dhcp_options *) ovsdb_idl_index_init_row(idl, class_);
}
...
struct nbrec_dns *
nbrec_dns_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_dns *) ovsdb_idl_index_init_row(idl, class_);
}
...
struct nbrec_gateway_chassis *
nbrec_gateway_chassis_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_gateway_chassis *) ovsdb_idl_index_init_row(idl, class_);
}
...
struct nbrec_load_balancer *
nbrec_load_balancer_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_load_balancer *) ovsdb_idl_index_init_row(idl, class_);
}
...
struct nbrec_logical_router *
nbrec_logical_router_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_logical_router *) ovsdb_idl_index_init_row(idl, class_);
}
...
struct nbrec_logical_router_port *
nbrec_logical_router_port_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_logical_router_port *) ovsdb_idl_index_init_row(idl, class_);
}
...
struct nbrec_logical_router_static_route *
nbrec_logical_router_static_route_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_logical_router_static_route *) ovsdb_idl_index_init_row(idl, class_);
}
...
struct nbrec_logical_switch *
nbrec_logical_switch_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_logical_switch *) ovsdb_idl_index_init_row(idl, class_);
}
...
struct nbrec_logical_switch_port *
nbrec_logical_switch_port_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_logical_switch_port *) ovsdb_idl_index_init_row(idl, class_);
}
...
struct nbrec_nat *
nbrec_nat_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_nat *) ovsdb_idl_index_init_row(idl, class_);
}
...
struct nbrec_nb_global *
nbrec_nb_global_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_nb_global *) ovsdb_idl_index_init_row(idl, class_);
}
...
struct nbrec_qos *
nbrec_qos_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_qos *) ovsdb_idl_index_init_row(idl, class_);
}
...
nbrec_qos_index_set_bandwidth(const struct nbrec_qos *row, const char **key_bandwidth, const int64_t *value_bandwidth, size_t n_bandwidth)
{
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_STRING, OVSDB_TYPE_INTEGER);
    ovsdb_idl_index_write_(CONST_CAST(struct ovsdb_idl_row *, &row->header_), &nbrec_qos_columns[ NBREC_QOS_COL_BANDWIDTH ], &datum, &nbrec_table_classes[NBREC_TABLE_QOS]);
}
...
struct ovsdb_idl_column nbrec_qos_columns[NBREC_QOS_N_COLUMNS] = {
    ...
    [NBREC_QOS_COL_BANDWIDTH] = {
         ...
         .type = {
            ...
            .value = {
                .type = OVSDB_TYPE_INTEGER,
                .u.integer = { .min = INT64_C(1), .max = INT64_C(4294967295) },
            },
            .n_min = 0,
            .n_max = UINT_MAX,
         },
...
struct nbrec_ssl *
nbrec_ssl_index_init_row(struct ovsdb_idl *idl, const struct ovsdb_idl_table_class *class_)
{
    return (struct nbrec_ssl *) ovsdb_idl_index_init_row(idl, class_);
}
